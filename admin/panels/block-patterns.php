...
<div class="flexbox align-between align-center-y mb-20">
    ...
    <div class="flexbox px-group radius-sm">
        <!-- Reset Button -->
        <button class="btn bg-alpha-10 color-gray radius-sm fs-12 pds-reset-data" type="button" data-reset="block_patterns"><?php echo __('Reset Patterns', 'phenix'); ?></button>
        <!-- Button -->
        <button type="button" class="btn success radius-sm" data-modal="block_patterns_form"><?php echo __('Add New', 'phenix'); ?></button>
    </div>
</div>
<!-- metabox List -->
<ul class="reset-list border-1 border-solid border-alpha-15 radius-sm fs-14 block_patterns_list" data-type="block_patterns">
    <li class="list-head flexbox divider-b align-center-y pdy-10 pds-15 pde-10 mb-0 weight-medium bg-offwhite-smoke radius-sm radius-top">
        ...
        <span class="col w-max-260"><?php echo __('Name', 'phenix'); ?></span>
        <span class="col w-max-260"><?php echo __('Categories', 'phenix'); ?></span>
    </li>
</ul>
<!-- Pagination Buttons -->
...
<div class="px-modal hidden align-center" id="block_patterns_form">
    ...
    <div class="modal-content w-max-480 bg-white radius-sm collection-form" data-type="block_patterns">
        <!-- Headline -->
        <h4 class="fs-15 pdx-20 pdy-10 divider-b"><?php echo __('Add New Pattern', 'phenix'); ?></h4>
        <!-- Close Button -->
        ...
        <div class="pdx-20 pdt-10">
            <!-- Description -->
            <p class="fs-14"><?php echo __('you can add/edit gutenberg block patterns from the next form.', 'phenix'); ?></p>
            <!-- Grid -->
        ...
        <div class="pdx-20 pdy-10 divider-t flexbox align-between">
            <button class="add-item btn primary small radius-sm"><?php echo __('Save', 'phenix'); ?></button>
