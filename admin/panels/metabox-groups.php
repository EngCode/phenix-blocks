...
<div class="flexbox align-between align-center-y mb-20">
    <!-- Area Head -->
    <div class="col">
        <h3 class="fs-16 mb-0 weight-medium"><?php echo __('Metaboxes Groups List', "pds-blocks"); ?></h3>
        <p class="fs-14"><?php echo __('in here you can manage the metaboxes groups created by phenix-blocks.', "pds-blocks"); ?></p>
    </div>
    <!-- Button -->
    <button type="button" class="btn success radius-sm" data-modal="pds_metabox_group_form"><?php echo __('Add New', "pds-blocks"); ?></button>
</div>
<!-- metabox List -->
<ul class="reset-list border-1 border-solid border-alpha-15 radius-sm fs-14 pds_metabox_list" data-type="pds_metabox">
    <li class="list-head flexbox divider-b align-center-y pdy-10 pds-15 pde-10 mb-0 weight-medium bg-offwhite-smoke radius-sm radius-top">
        ...
        <span class="col w-max-200"><?php echo __('Types', "pds-blocks"); ?></span>
    </li>
</ul>
<!-- Pagination Buttons -->
...
<!-- Modal Component -->
<div class="px-modal hidden align-center" id="pds_metabox_group_form">
    <!-- Container -->
    <div class="modal-content w-max-480 bg-white radius-sm collection-form" data-type="pds_metabox">
        <!-- Headline -->
        <h4 class="fs-15 pdx-20 pdy-10 divider-b"><?php echo __('Add New Group', "pds-blocks"); ?></h4>
        <!-- Close Button -->
        ...
        <div class="pdx-20 pdt-10">
            <!-- Description -->
            <p class="fs-14"><?php echo __('you can add/edit metaboxes group from the next form.', "pds-blocks"); ?></p>
            <!-- Grid -->
            <div class="row gpx-15 gpy-15">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="control-icon far fa-map-marker-alt">
                        <select name="field_data" class="px-select form-control radius-sm fs-13" data-placeholder="<?php echo __('Data Location', "pds-blocks");?>">
                ...
                <div class="col-12 col-md-6">
                    <!-- Form Control -->
                    <div class="control-icon far fa-cube mb-15 post-types-select">
                    ...
                    <!-- Form Control -->
                    <div class="control-icon far fa-cube mb-15 taxonomies-select hidden">
