...
<script defer>
    document.addEventListener('DOMContentLoaded', ready => {
        ...
        async function get_post_types() {
            //===> Connect to the API <===//
            const response = await fetch(`${PDS_WP_KEY.root}options/pds_post_types`, {
        ...
        //===> Add New Post Type <===//
        async function add_post_type(post_types) {
            //===> Get Data <===//
            let data = {"post_types": post_types};
