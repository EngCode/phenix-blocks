...
<div class="flexbox align-between align-center-y mb-20">
    ...
    <!-- Button -->
    <button type="button" class="btn success radius-sm" data-modal="pds_taxonomies_form"><?php echo __('Add New', 'phenix'); ?></button>
</div>
<!-- taxonomies List -->
...
<div class="px-modal hidden align-center" id="pds_taxonomies_form">
    ...
    <div class="modal-content w-max-480 bg-white radius-sm collection-form" data-type="pds_taxonomies">
        <!-- Headline -->
        <h4 class="fs-15 pdx-20 pdy-10 divider-b"><?php echo __('Add New Taxonomy', 'phenix'); ?></h4>
        <!-- Close Button -->
        ...
        <div class="pdx-20 pdt-10">
            <!-- Description -->
            <p class="fs-14"><?php echo __('you can add/edit taxonomies from the next form.', 'phenix'); ?></p>
            <!-- Grid -->
