...
?>
<!-- Dashboard Wrapper -->
<div class="pds-dashboard my-30 me-30 bg-white radius-lg">
    <!-- Headline -->
    ...
    <div class="container">
        ...
        <div class="px-tabs radius-md border-solid border-1 border-alpha-10">
            ...
            <ul class="tabs-navigation reset-list flexbox overflow-hidden fs-15 mb-15 radius-md bg-alpha-05 radius-top divider-b">
                ...
                <li data-tab="section-2" class="btn light btn-icon mb-0 fs-12 weight-bold fas fa-link"><?php echo __("القوائم والروابط","phenix");?></li>
            </ul>
            <!-- Tabs Wrapper -->
            <div class="tabs-panels">
                <!-- Colors and Identity -->
                <div class="tab-panel tx-align-center pdy-10 pdx-30" id="section-1">
                    <img src="<?php echo $images_folder;?>/tuts/colors.png" width="900" alt="screenshot" class="fluid" />
                </div>
                <!-- Menus and Links -->
                <div class="tab-panel tx-align-center pdy-10 pdx-30" id="section-2">
