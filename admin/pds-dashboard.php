    ...
    <div class="container pdb-20">
        ...
        <div class="row divider-b pdx-5">
            ...
            <div class="col-12 col-md-4 divider-e pdy-25">
                ...
                <p class="weight-medium"><?php echo __("اهلا بكم فى الحقبة الجديدة من الووردبريس بواسطة <a href='https://phenixthemes.com/pds-docs/'>Phenix Design System</a> لمعرفة المزيد اضغط علي <a href='#about'>المزيد عن نظام فينكس.</a>.","phenix");?></p>
            </div>
            <!-- Column -->
