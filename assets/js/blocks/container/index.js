...
/* harmony import */ var _px_controls_alignment__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../px-controls/alignment */ "./src/blocks/px-controls/alignment.js");
...
function Edit(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(_px_controls_alignment__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_1__, {
  ...
  save: function save(_ref) {
    ...
    if (attributes.isFlexbox) {
      ...
      if (attributes.flexbox.stacked) container += " ".concat(attributes.flexbox.stacked);
    } //===> Typography Properties <===//
    ...
    if (typography) {
      ...
      if (typography.align) container += " ".concat(typography.align);
    } //===> Render Background <===//
