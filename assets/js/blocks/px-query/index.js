...
function Edit(props) {
  ...
  var set_query_type = function set_query_type(query_type) {
    return setAttributes({
  ...
  var setPhenixView = function setPhenixView() {
    ...
    if (siteEditor) {
      ...
      if (attributes.isSlider) {
        var sliderElements = siteEditor.document.querySelectorAll('.px-slider');
        sliderElements = _toConsumableArray(sliderElements);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
  ...
  }), attributes.query_type === 'custom' ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.SelectControl, {
    label: "Post Type",
    ...
    min: 3,
    max: 36
  })) : null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.ToggleControl, {
    label: "Carousel Mode",
  ...
  }))), attributes.post_type === 'home-slider' ? /*#__PURE__*/React.createElement("img", {
...
/***/ "./src/blocks/px-query/block.json":
/*!****************************************!*\
  !*** ./src/blocks/px-query/block.json ***!
  \****************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"apiVersion":2,"name":"phenix/px-query","version":"0.1.0","title":"PDS Query","category":"design","description":"Custom Query Posts Block.","supports":{"html":false},"attributes":{"query_type":{"type":"string","default":"native"},"post_type":{"type":"string","default":"post"},"per_page":{"type":"number","default":8},"order":{"type":"string","default":"DESC"},"isSlider":{"type":"boolean","default":false},"pagination":{"type":"boolean","default":false}},"textdomain":"phenix","editorScript":"px-query"}');
...
(() => {
/*!**************************************!*\
  !*** ./src/blocks/px-query/index.js ***!
  \**************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./edit */ "./src/blocks/px-query/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/px-query/block.json");
