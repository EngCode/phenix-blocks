...
function Edit(props) {
  ...
  blockProps.className += ' col tx-align-center'; //===> Render <===//
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
    ...
    className: "pdy-30 pdx-25 bg-alpha-05 radius-md border-1 border-dashed border-alpha-25 fs-14"
  }, "Dynamic Query Loop For : ", attributes.post_type)) // <ServerSideRender block="phenix/query" attributes={attributes} />
  );
}
