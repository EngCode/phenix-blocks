    ...
    return (<>
        ...
        <BlockControls>
            <Toolbar label={__("Quick Settings", "pds-blocks")}>
                ...
                {/*===> Select Control <===*/}
                <div className='inline-block inline-select tooltip w-75' data-title={__("Container Size", "pds-blocks")}>
                ...
                <OptionControl key={`isSection-${uniqueKey}`} name={`isSection`} value={`boolean`} checked={attributes.isSection} onChange={set_value} type='button-checkbox' className='inline-block divider-e border-alpha-25'>
                    <span className='btn bg-transparent fs-16 square tooltip far fa-box h-min-100' style={{paddingTop: 2}} data-title={__("Container Wrapper", "pds-blocks")}></span>
                </OptionControl>
                {/*===> Dropdown Button <===*/}
