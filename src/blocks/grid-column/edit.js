    ...
    return (<>
        ...
        <BlockControls>
            <ToolbarGroup key={`${uniqueKey}-toolbar`} label={__("Quick Settings", "pds-blocks")}>
                {/*===> Dropdown Button <===*/}
                <PxDropDown title={__("Column Size", "pds-blocks")} button={`bg-transparent fs-16 square fas fa-arrows-alt-h divider-e border-alpha-25 h-100`} dropList="fs-14 w-min-180">
                    <li key="pds-styles" className='pdt-15 pdb-5 pdx-15 lineheight-150'>
                        <PhenixNumber name={"size"} icon="fas fa-mobile-alt" min={0} max={13} value={attributes.size || 0} onChange={set_value} />
                        <PhenixNumber name={`size-sm`} icon="fas fa-mobile" min={0} max={13} value={attributes.responsive[`size-sm`] || 0} onChange={(target) => set_responsive(target)} />
                        <PhenixNumber name={`size-md`} icon="fas fa-tablet" min={0} max={13} value={attributes.responsive[`size-md`] || 0} onChange={(target) => set_responsive(target)} />
                        <PhenixNumber name={`size-lg`} icon="fas fa-laptop" min={0} max={13} value={attributes.responsive[`size-lg`] || 0} onChange={(target) => set_responsive(target)} />
                        <PhenixNumber name={`size-xl`} icon="fas fa-desktop" min={0} max={13} value={attributes.responsive[`size-xl`] || 0} onChange={(target) => set_responsive(target)} />
                    </li>
                </PxDropDown>
                {/*===> Dropdown Button <===*/}
                ...
                {/*===> Dropdown Button <===*/}
                {attributes.isFlexbox? <PxDropDown title={__("Layout Options", "pds-blocks")} button={`bg-transparent fs-16 square fas fa-columns color-success divider-e border-alpha-25 h-100`} dropList="fs-14 w-min-280">
                ...
                <OptionControl key={`isFlexbox-${uniqueKey}`} name={`isFlexbox`} value={`boolean`} checked={attributes.isFlexbox} onChange={set_value} type='button-checkbox' className='inline-block divider-e border-alpha-25'>
                    <span className='btn bg-transparent fs-16 square tooltip-bottom fas fa-columns h-min-100' style={{paddingTop: 2}} data-title={__("Flexbox Layouts", "pds-blocks")}></span>
                </OptionControl>}
                {/*===> Dropdown Button <===*/}
