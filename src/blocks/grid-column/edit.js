...
export default function Edit({ attributes, setAttributes }) {
    ...
    Object.entries(attributes).forEach(([option_name, option_value]) => {
        //===> Exclude Options <===//
        const excluded = ["tagName", "className", "metadata"];
        ...
        //===> for Boolean Options <===//
            ...
            //===> Flexbox <===//
            if (option_name === "isFlexbox") innerBlocksProps.className += ` flexbox`;
        }
            ...
            Object.entries(option_value).forEach(([sub_option, sub_value]) => {
                ...
                //===> for Normal strings and Arrays <===//
                    ...
                    //===> Other Values <===//
                        ...
                        if (!attributes.isFlexbox) blockProps.className += ` ${sub_value.toString().replace(',', ' ').trim()}`;
    ...
    return (<>
        ...
        <InspectorControls key={`${uniqueKey}-inspector`}>
            ...
            <PanelBody title={__("General Options", "pds-blocks")} initialOpen={true}>
                ...
                {/*===> Styles Options <===*/}
                <StylesSet key={`styles-${uniqueKey}`} attributes={attributes} mainSetter={set_style} options="support" />
            </PanelBody>
            {/*===> End Widgets Panels <===*/}
        </InspectorControls>
