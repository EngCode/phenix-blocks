    ...
    return (<>
        ...
        <BlockControls>
            <Toolbar label={__("Quick Settings", "pds-blocks")}>
                {/*===> Select Control <===*/}
                <div className='inline-block inline-select tooltip w-100' data-title={__("Type", "pds-blocks")}>
                ...
                {/*===> Select Control <===*/}
                <div className='inline-block inline-select tooltip w-75' data-title={__("Ratio Size", "pds-blocks")}>
                ...
                {/*===> Select Control <===*/}
                {attributes.setting.type === "embed" ? <div className='inline-block inline-select tooltip w-100' data-title={__("Embed Source", "pds-blocks")}>
