                ...
                {!options || options.includes("align") ? <>
                    <div className='col-12 mb-15'>
                        ...
                        {!options || options.includes('align-self') ? <>
                            <PhenixSelect className="mt-15" name={`align-self${screen}`} size="normal" placeholder={__("None", "pds-blocks")} className="stacked-options" label={__("Self Align", "pds-blocks")} value={attributes.flexbox[`align-self${screen}`]} onChange={mainSetter} options={align_options} />
                        </>:null}
                    </div>
                </>: null}
                {/*===> Group <===*/}
