        ...
        return <>
            <div className={`row gpx-15 ${className ? className : ""}`}>
                ...
                <div className='col-12 mb-15'>
                    <FlexAlignment label={__("Flexbox Alignment", "phenix")} value={attributes.grid[`align${screenPoint}`] || ""} onChange={!screen ? mainSetter : (target) => mainSetter(target, screen)}></FlexAlignment>
                </div>
                </>: null}
                {/*===> Column <===*/}
