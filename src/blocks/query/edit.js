        ...
        <BlockControls>
            <ToolbarGroup label={__("Quick Settings", "pds-blocks")}>
                ...
                {attributes.flexbox?.equals || attributes.flexbox?.slider ? <>
                    <PxDropDown title={__("Columns Number", "pds-blocks")} button={`bg-transparent fs-16 square fas fa-columns divider-e border-alpha-25 h-100`} dropList="fs-14 w-min-180">
