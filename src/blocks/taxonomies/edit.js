    ...
    return (<>
        ...
        <InspectorControls key="inspector">
            ...
            <PanelBody title="Setting" initialOpen={true}>
                {/*===> Taxonomy <===*/}
                <SelectControl label="Taxonomy" value={attributes.taxonomy} onChange={set_taxonomy} options={[
                ...
                {/*===> Post Type <===*/}
                <SelectControl label="Data Type" value={attributes.post_type} onChange={set_post_type} options={[
